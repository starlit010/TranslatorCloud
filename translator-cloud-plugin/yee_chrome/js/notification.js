...
// var info_url = "http://192.168.17.50:8080/info/queryByNotifications";
...
// 自动推送接口
var aotuInfo = httphostname+"/info/aotuInfo";
// var aotuInfo = "http://192.168.17.50:8080/info/aotuInfo";
	...
	$.ajax({
	  ...
	  success: function(data) {
	    ...
	    if(data.code==1){
			...
			localStorage["cache_info_"+data.data.id] = data.data.infoLink;
	    }	    
