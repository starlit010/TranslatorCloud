...
function showSearchTip(){
	...
	if($("#searchTip").length == 0){
		$("#guide-step").before("<div id='searchTipBg' style='width:100%; height:100%; left:0px; top:0px; z-index:9999; background-color:#000; opacity:0.55; filter:alpha(opacity=55);position:"+ position +"'></div>");
		$("#guide-step").before("<div id='searchTip' style='width:100%; z-index:10005; background-color:transparent; position:fixed;'>"+ searchTipInner +"</div>");
