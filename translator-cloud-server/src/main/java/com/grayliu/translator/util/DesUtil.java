...
public class DesUtil {
    ...
    public static void main(String[] args) {
        ...
        String key1 = "20161017";//密钥1
        String key2 = "_";//密钥2
        String key3 = "TWGDH";//密钥3
        String data = "admin";
     ...
     * @date 2016-10-17 下午5:06:34
     */
    public static boolean yeekitDesCheck(String at){
    	DesUtil desObj = new DesUtil();
    	Calendar cal=Calendar.getInstance();
        String key1 = cal.get(Calendar.YEAR)+""+(cal.get(Calendar.MONTH)+1)+cal.get(Calendar.DATE);//密钥1
        String key2 = "_";//密钥2
        String key3 = "yeekit";//密钥3
        String data = "yeekit";
//        String str = desObj.strEnc(data, key1, key2, key3);
//        System.out.println(str);
        String dec = desObj.strDec(at, key1, key2, key3);
        if(data.equals(dec)){
        	return true;
        }else{
        	return false;        	
