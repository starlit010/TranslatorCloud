package com.grayliu.translator.util.langdetect;

import com.alibaba.fastjson.JSONException;
import com.alibaba.fastjson.JSONObject;
import com.grayliu.translator.util.langdetect.util.LangProfile;
...
public class DetectorFactory {
    ...
    public static void loadProfile(File profileDirectory) throws LangDetectException {
        ...
        for (File file: listFiles) {
            ...
            try {
                ...
                LangProfile profile = JSONObject.parseObject(is, LangProfile.class);
    ...
    public static void loadProfile() throws LangDetectException {
    	try{
    		...
    		throw new LangDetectException(ErrorCode.FileLoadError, com.ttsx.platform.tool.util.StringUtil.stackTrace2String(e));
    	}
    }
    ...
    public static void loadProfile(List<String> json_profiles) throws LangDetectException {
        ...
        for (String json: json_profiles) {
            try {
                LangProfile profile = JSONObject.parseObject(json, LangProfile.class);
                addProfile(profile, index, langsize);
                ++index;
            } catch (JSONException e) {
